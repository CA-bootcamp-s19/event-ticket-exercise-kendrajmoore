...
contract EventTicketsV2 {
    ...
    */
    function addEvent(string memory description, string memory url, uint numTickets)
        public
        isOwner
    ...
    */
    function readEvent(uint eventId)
        public
        view
        returns(string memory description, string memory url, uint available, uint sales, bool isOpen)
    {
